...
public class User extends BaseTable
{
	...
	public User(OCMConnection connection, String userID)
	{
		//Store the key field
		this.userID = userID;
	...
	public static User tryGetFromEmail(String key, OCMConnection connection) throws Exception
	{
		...
		try
		{
			...
			return new User(connection, index);
		}
	...
	{			
		...
		public User tryGetNext() throws IllegalArgumentException, NotFoundException, Exception
		{
			...
			//Create a new user
			User result = new User(connection, rowData.getKey());
