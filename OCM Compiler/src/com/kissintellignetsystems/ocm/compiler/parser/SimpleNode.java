...
public class SimpleNode implements Node {
  ...
  protected OCMParser parser;

  public SimpleNode(int i) {
    id = i;
  }

  public SimpleNode(OCMParser p, int i) {
    this(i);
    parser = p;
  }
  ...
  public String toString() { return OCMParserTreeConstants.jjtNodeName[id]; }
...
/* JavaCC - OriginalChecksum=7969e68b5cbf7033f49a5f2b7891f0e6 (do not edit this line) */
